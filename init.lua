...
vim.keymap.set('n', '<leader>c', '<cmd> Oil ~/.config/nvim<cr>', { desc = 'Oil - NeoVim Config' })
...
require('lazy').setup({
  ...
  --require 'kickstart.plugins.lint', NOTE: breaks a lot of stuff after opening markdown files
